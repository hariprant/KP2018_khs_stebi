                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            foreach($dosen as $d){
                            ?>
                            <li><a href="javascript:void(0);"><?php echo $d->nama_dsn ?></a></li>
                            <?php } ?>
                            <li role="separator" class="divider"></li>
                            <li><a href="<?php echo site_url('dosen/profil'); ?>"><i class="material-icons">person</i>Profil</a></li>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="user-info">
                ...
                <div class="info-container" style="top: 10px;">
                    <div class="name"><b><?php echo $d->nama_dsn ?></b></div>
                    <div class="email"><?php echo $d->nip ?></div>
                </div>
            </div>
            <?php } ?>
            <!-- #User Info -->
            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="<?=$this->session->flashdata('nilai')?>">
                        ...
                        <ul class="ml-menu">
                            <li class="<?=$this->session->flashdata('nilai')?>">
                                <a href="<?php echo base_url()?>dosen/nilai">
